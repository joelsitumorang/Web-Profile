...
4.  **[AgunanSection](file:///d:/Yongki/PT%20MBG/Web%20Profile/frontend/src/components/AgunanSection.tsx)**: Grid responsif yang menampilkan 5 kategori agunan konvensional (Emas, Elektronik, Alat Rumah Tangga, Kendaraan, Alat Tukang). Dilengkapi dengan state seleksi aktif dan kontainer rincian barang, tenor, estimasi sewa modal (bunga), serta syarat kunci yang berubah secara dinamis di bawahnya.
5.  **[PawnRequirements](file:///d:/Yongki/PT%20MBG/Web%20Profile/frontend/src/components/PawnRequirements.tsx)**: Panduan persyaratan dua tingkat yang memisahkan Syarat Umum (KTP asli) dengan tabel pemetaan syarat tambahan per 5 kategori agunan.
